...
//  Copyright © 2020 Tad Scritchfield. All rights reserved.
//
...
private:
    ...
    std::vector<VkSemaphore>        imageAvailibleSemaphore;
    ...
    void createSyncObjects() {
        imageAvailibleSemaphore.resize(MAX_FRAMES_IN_FLIGHT);
        ...
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
            if (vkCreateSemaphore(device, &semaphoreInfo, nullptr, &imageAvailibleSemaphore[i]) != VK_SUCCESS
...
//    }
    ...
    void createGraphicsPipeline() {
        ...
        colorBlendAttatchment.blendEnable = VK_FALSE;
    ...
    void drawFrame() {
        ...
        uint32_t imageIndex;
        vkAcquireNextImageKHR(device, swapChain, UINT64_MAX, imageAvailibleSemaphore[currentFrame], VK_NULL_HANDLE, &imageIndex);
        ...
        VkSemaphore waitSemaphores[] = {imageAvailibleSemaphore[currentFrame]};
    ...
    void cleanup() {
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
            ...
            vkDestroySemaphore(device, imageAvailibleSemaphore[i], nullptr);
